...
public class IntermedioAdapter extends ArrayAdapter<IntermedioItem> {
    private final List<IntermedioItem> itemList;
    private final View.OnClickListener clickListener;
    public IntermedioAdapter(
            Context context, List<IntermedioItem> items, View.OnClickListener listener) {
    ...
    @Override
    public IntermedioItem getItem(int position) {
